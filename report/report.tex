...
\begin{figure}[htbp]
    \centerline{\includegraphics[width = .5\linewidth]{images/basic_3.png}}
    \captionsetup{width = .5\linewidth}
    \caption{The graph produced by `\texttt{lsr.py}' for `\texttt{basic\_3.csv}'}
...
the `\texttt{basic\_3.csv}' unknown signal;
the output is shown in Figure \ref{fig:basic_3.csv}.
...
\begin{figure}[htbp]
    \centerline{\includegraphics[width = .5\linewidth]{images/basic_5.png}}
    \captionsetup{width = .5\linewidth}
    \caption{The graph produced by \texttt{lsr.py} for \texttt{basic\_5.csv}}
...
`\texttt{lsr.py}'
least-squares regression program, I ran the program on
the `\texttt{basic\_5.csv}' unknown signal;
the output is shown in Figure \ref{fig:basic_5.csv}.
