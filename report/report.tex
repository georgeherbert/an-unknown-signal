...
\centering
\begin{minipage}[b]{.49\textwidth}
    \includegraphics[width=\textwidth]{images/noise_2_0_polynomial.png}
    \caption{Polynomial fit for first line segment in `\texttt{noise\_2.csv}'}
    \label{fig:basic_5.csv}
\end{minipage}
\hfill
\begin{minipage}[b]{.49\textwidth}
    \includegraphics[width=\textwidth]{images/noise_2_0_linear.png}
    \caption{Linear fit for for first line segment in `\texttt{noise\_2.csv}'}
    \label{fig:adv_3.csv}
\end{minipage}
\end{figure}
