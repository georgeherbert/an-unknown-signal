...
\begin{figure}[htbp]
    \centering
    \subfloat[Cubic fit]{\includegraphics[width = 0.45\textwidth]{images/noise_2_0_polynomial.png}\label{fig:f1}}
    \hfill
    \subfloat[Linear fit]{\includegraphics[width = 0.45\textwidth]{images/noise_2_0_linear.png}\label{fig:f2}}
