...
this resulted in the program often providing wildly different results.
...
of my program. To do so, I implemented $k$-fold cross-validation.
In particular, I opted to use leave-one-out cross-validation
when producing a model for each 20-point line segment.
...
I believe it to be an appropriate technique in this case.
