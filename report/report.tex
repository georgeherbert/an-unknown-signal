...
\begin{figure}[htbp]
    \centering
    \subfloat[Quadratic fit]{\includegraphics[width = 0.4\textwidth]{images/basic_3_quadratic.png}\label{fig:basic_3_quadratic.csv}}
    \hfill
    \subfloat[Cubic fit]{\includegraphics[width = 0.4\textwidth]{images/basic_3.png}\label{fig:basic_3_cubic.csv}}
...
\begin{figure}[htbp]
    \centering
    \subfloat[Cosine fit]{\includegraphics[width = 0.4\textwidth]{images/basic_5_cosine.png}\label{fig:basic_5_cosine.csv}}
    \hfill
    \subfloat[Sine fit]{\includegraphics[width = 0.4\textwidth]{images/basic_5.png}\label{fig:basic_5_sine.csv}}
    \caption{Two fits for `\texttt{basic\_3.csv}'}
...
\begin{figure}[htbp]
    \centering
    \subfloat[Cubic fit]{\includegraphics[width = 0.4\textwidth]{images/noise_2_0_polynomial.png}\label{fig:f1}}
    \hfill
    \subfloat[Linear fit]{\includegraphics[width = 0.4\textwidth]{images/noise_2_0_linear.png}\label{fig:f2}}
