...
I believe this is important as it leaves my code open to
computing the best model for line segments of far greater length than 20.
The constant `\texttt{POINTS\_IN\_SEGMENT}' can increased to do this,
and a lower value of $k$ can be used to decrease the computational cost.
